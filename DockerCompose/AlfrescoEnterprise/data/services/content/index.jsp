      ...
      <div class="index">
        ...
        <div class="index-list">
         ...
         <p></p>
          ...
          <p></p>
          <p><a href="" onclick="window.open('http://'+ window.location.hostname + ':3000')">OpenWebUI for AI Chat</a></p>
          <p></p>
          <p><a href="" onclick="window.open('http://'+ window.location.hostname + ':8001/docs')">MCP Server for Alfresco</a></p>
          <p></p>
